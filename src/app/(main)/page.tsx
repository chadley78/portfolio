      ...
      <section className="py-8 sm:py-12 lg:py-16">
        <div className="w-full">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16 lg:mb-20">
            <motion.div
              className="text-4xl sm:text-5xl md:text-6xl lg:text-[4rem] xl:text-[4.9rem] font-bold text-[#242424] mb-4 sm:mb-6 lg:mb-8 leading-tight text-center"
            >
              My Work
            </motion.div>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
                        ...
                        <div className="flex items-center justify-center lg:justify-end lg:pr-16">
                          <Link href={`/projects/${project.slug}`} className="w-full lg:w-4/5 h-[80vh] relative block">
                            ...
                            ) : project.slug === "coding-exercise-tool" ? (
                              // IDE image for Coding Exercise Tool project
                              <Image
                                src="https://ulethzcxykotndiahpmm.supabase.co/storage/v1/object/public/portfolio-assets//IDE.png"
                                alt={project.title}
                                width={600}
                                height={800}
                                className="w-full h-full object-cover rounded-lg"
